...
resource "ipm_network_connection" "network_connections" {
  ...
  endpoints = [for endpoint in each.value.endpoints :
    {
      config = {
        selector = endpoint.identifier.module_id == null ? (endpoint.identifier.module_name == null ? (endpoint.identifier.mac_address == null ? (endpoint.identifier.serial_number == null ? (endpoint.identifier.host_name == null ? (endpoint.identifier.host_port_id == null ? (endpoint.identifier.host_sys_name == null ? (endpoint.identifier.host_port_source_mac == null ? null : { host_port_selector_by_port_source_mac = { port_source_mac = endpoint.identifier.port_source_mac } }) : { host_port_selector_by_sys_name = { sys_name = endpoint.identifier.host_sys_name, port_id = endpoint.identifier.host_port_id, port_id_subtype = endpoint.identifier.host_port_id_subtype } }) : { host_port_selector_by_port_id = { chassis_id = endpoint.identifier.host_chassis_id, chassis_id_subtype = endpoint.identifier.host_chassis_id_subtype, port_id = endpoint.identifier.host_port_id, port_id_subtype = endpoint.identifier.host_port_id_subtype } }) : { host_port_selector_by_name = { host_name = endpoint.identifier.host_name, host_port_name = endpoint.identifier.host_port_name } }) : { module_if_selector_by_module_serial_number = { module_serial_number = endpoint.identifier.serial_number, module_client_if_aid = endpoint.identifier.module_client_if_aid } }) : { module_if_selector_by_module_mac = { module_mac = endpoint.identifier.mac_address, module_client_if_aid = endpoint.identifier.module_client_if_aid } }) : { module_if_selector_by_module_name = { module_name = endpoint.identifier.module_name, module_client_if_aid = endpoint.identifier.module_client_if_aid } }) : { module_if_selector_by_module_id = { module_id = endpoint.identifier.module_id, module_client_if_aid = endpoint.identifier.module_client_if_aid }
        }
        capacity = endpoint.capacity != null ? endpoint.capacity : var.nc_profiles[each.value.profile].endpoint_capacity
      }
  }]
}
