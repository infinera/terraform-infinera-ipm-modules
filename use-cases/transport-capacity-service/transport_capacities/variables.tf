variable "transport_capacities" {
  ...
  default = [{ name: "TC2", profile = "system_tc_profile1",
                end_points : [{ identifier: { module_client_if_aid: "XR-T1", module_name: "A-LRN-Hub-Orlando"}},
                             { identifier: { module_client_if_aid: "XR-T1", module_name: "A-LRN-Leaf1-BR"} }]
            }]
}
...
variable "system_profile" {
  type    = string
  default = "/home/lhoang/ipmProjects/terraform-ipm-modules/use-cases/system-profiles/tc_profiles.json"
}

variable "user_profile" {
  type    = string
  default = "/home/lhoang/ipmProjects/terraform-ipm-modules/use-cases/user-profiles/tc_profiles.json"
}
