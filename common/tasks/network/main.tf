...
resource "ipm_constellation_network" "constellation_networks" {
  ...
  hub_module = {
    config = {
      selector = each.value.hub_module.id == null ? (each.value.hub_module.name == null ? (each.value.hub_module.mac_address == null ? (each.value.hub_module.serrial_number == null ? (each.value.hub_module.host_name == null ? (each.value.hub_module.host_port_id == null ? (each.value.hub_module.host_sys_name == null ? (each.value.hub_module.host_port_source_mac == null ? null : { host_port_selector_by_port_source_mac = { port_source_mac = each.value.hub_module.port_source_mac } }) : { host_port_selector_by_sys_name = { sys_name = each.value.hub_module.host_sys_name, port_id = each.value.hub_module.host_port_id, port_id_subtype = each.value.hub_module.host_port_id_subtype } }) : { host_port_selector_by_port_id = { chassis_id = each.value.hub_module.host_chassis_id, chassis_id_subtype = each.value.hub_module.host_chassis_id_subtype, port_id = each.value.hub_module.host_port_id, port_id_subtype = each.value.hub_module.host_port_id_subtype } }) : { host_port_selector_by_name = { host_name = each.value.hub_module.host_name, host_port_name = each.value.hub_module.host_port_name } }) : { module_selector_by_module_serial_number = { module_serial_number = each.value.hub_module.serial_number } }) : { module_selector_by_module_mac = { module_mac = each.value.hub_module.mac_address } }) : { module_selector_by_module_name = { module_name = each.value.hub_module.name } }) : { module_selector_by_module_id = { module_id = each.value.hub_module.id }
      }
      module = {
