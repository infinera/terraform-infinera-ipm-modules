variable "networks" {
  type = list(object({ name = optional(string),
    ...
    hub_module = object({ host_chassis_id = string, host_chassis_id_subtype = string, host_port_id = string, host_port_id_subtype = string,
    ...
    leaf_modules = optional(list(object({ host_chassis_id = string, host_chassis_id_subtype = string, host_port_id = string, host_port_id_subtype = string,
